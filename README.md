...
Please note that [Quaspy](https://github.com/ekera/quaspy) depends on [GMP](https://gmplib.org) and [MPFR](https://www.mpfr.org) via the [gmpy2](https://github.com/aleaxit/gmpy) wrapper for [Python3](https://www.python.org), and that there is a [memory leak issue](https://github.com/aleaxit/gmpy/issues/569) in [gmpy2](https://github.com/aleaxit/gmpy) in versions earlier than [2.2.2a1](https://pypi.org/project/gmpy2/2.2.2a1). If you are experiencing memory leak issues when using [Quaspy](https://github.com/ekera/quaspy) please make sure that you have version [2.2.2a1](https://pypi.org/project/gmpy2/2.2.2a1) or later of [gmpy2](https://github.com/aleaxit/gmpy) installed.
...
If you get an error message to the effect that the environment is externally managed, you first need to setup a virtual environment, by executing:
```console

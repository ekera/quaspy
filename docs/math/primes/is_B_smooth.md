...
As in [[E24]](https://doi.org/10.1145/3655026), d is said to be B-smooth if d = q1^e1 * .. qk^ek, for q1, ..., qk pairwise distinct primes, and e1, ..., ek positive integer exponents, if it holds that qi^ei <= B for all i in [1, k].
